...
import { FaCloudversify, FaSnipper, FaCloudRain, FaArrowDown, FaArrowUp } from 'react-icons/fa'
    ...
    <> {/* React Fragment */}
      <Navbar bg="primary">
        ...
        <Form inLine>
          ...
          &nbsp;
          <Button variant="secondary" onClick={() => { obtemClima(cidade) }}> <FaCloudversify /> ObterClima</Button>
        </Form>
      </Navbar>
      <Jumbotron>
